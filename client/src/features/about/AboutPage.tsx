...
import { useLazyGet400ErrorQuery, useLazyGet401ErrorQuery, useLazyGet404ErrorQuery, useLazyGet501ErrorQuery, useLazyGetValidationErrorQuery } from "./errorApi";
...
export default function AboutPage() {
  ...
  const [trigger501Error] = useLazyGet501ErrorQuery();
  ...
  return (
    <Container maxWidth='lg'>
      ...
      <ButtonGroup fullWidth>
        ...
        <Button variant="contained" onClick={() => trigger501Error().catch(err => console.log(err))}>Test 501 Error</Button>
